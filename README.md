...
## The Open-Source Data Science Program

The open-source curriculum for learning Data Science. Foundational in both theory and technologies, online resources break down the core competencies necessary to making use of data.
...
* **Statistics**
 * Statistics 110: [Harvard the most popular Statistics Course](http://bit.ly/2Fge2Yj)
 ...
 * Machine Learning with Scikit-Learn, PyCon2015 [youtube tutorials](http://bit.ly/2El2h1x)
 ...
 * Interactive web-based visualizations [Harvard University Lectures](http://bit.ly/2m9GCmg)
 ...
 * [A Gallery of Interesting IPython Notebooks](http://bit.ly/2r7mvWD)
 * [Links to the best IPython and Jupyter Notebooks](http://bit.ly/2bI2myR)
